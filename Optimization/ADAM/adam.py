...
# Define the transformation for the data (e.g., normalize it)
...
trainX = train_dataset.data.numpy()  # [60000, 28, 28] images
trainy = train_dataset.targets.numpy()  # [60000] labels
testX = test_dataset.data.numpy()  # [10000, 28, 28] images
testy = test_dataset.targets.numpy()  # [10000] labels
